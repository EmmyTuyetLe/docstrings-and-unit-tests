...
def is_mel(name, email):
    """Is this user Mel?
       ...
       >>> is_mel("Jane Smith", "jane@smith.com")
       False
...
def most_and_least_common_type(treats):
    ...
    >>> treats = [{'type': 'appetizer'}, {'type': 'appetizer'}, {'type': 'dessert'}, {'type': 'dessert'},{'type': 'drink'}]
    >>> most_and_least_common_type(treats)
    (['appetizer', 'dessert'], 'drink')

    >>> treats = [{'type': 'dessert'},{'type': 'drink'}, {'type': 'appetizer'}, {'type': 'appetizer'}, {'type': 'drink'}]
    >>> most_and_least_common_type(treats)
    (['drink', 'appetizer'], 'drink')
